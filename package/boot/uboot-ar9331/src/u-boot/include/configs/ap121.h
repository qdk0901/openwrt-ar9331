...
#define AR7240_SPI_CONTROL_DEFAULT	MAKE_AR9331_SPI_CONTROL_VAL(10) //failed with 6 qdk++
 ...
 */
	...
	#define CFG_ENV_SECT_SIZE	0x10000
#elif defined(CONFIG_FOR_SXX_AR9331)
	#define CFG_ENV_ADDR		0x9F01E000
...
#if DEFAULT_FLASH_SIZE_IN_MB == 8
#define UPDATE_SCRIPT_ART_ADDR "0x9F7F0000"
#elif DEFAULT_FLASH_SIZE_IN_MB == 16
#define UPDATE_SCRIPT_ART_ADDR "0x9FFF0000"
#endif

#define CONFIG_EXTRA_ENV_SETTINGS	"uboot_addr=0x9F000000\0" \
									"uboot_name=tuboot.bin\0" \
									...
									"fu=" \
										...
										"echo OK!; \0" \
									"art_addr=" UPDATE_SCRIPT_ART_ADDR "\0" \
									"art_name=art.bin\0" \
									"au=" \
										"tftp $loadaddr $art_name && " \
										"erase $art_addr +$filesize && " \
										"cp.b $loadaddr $art_addr $filesize && " \
										"echo OK!; " \
									SILENT_ENV_VARIABLE
...
#elif defined(CONFIG_FOR_SXX_AR9331)
	#define OFFSET_MAC_DATA_BLOCK			0x01F000
	#define OFFSET_MAC_DATA_BLOCK_LENGTH	0x001000
	#define OFFSET_MAC_ADDRESS				0x000C00	
#else
	#define OFFSET_MAC_DATA_BLOCK			0x010000
	#define OFFSET_MAC_DATA_BLOCK_LENGTH	0x010000
	#define OFFSET_MAC_ADDRESS				0x00FC00
